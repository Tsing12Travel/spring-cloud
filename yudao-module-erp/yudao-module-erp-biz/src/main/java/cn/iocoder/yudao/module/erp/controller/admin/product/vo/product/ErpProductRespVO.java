...
public class ErpProductRespVO {
    @Schema(description = "产品编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "111111")
    @ExcelProperty("产品编号")
    private Long id;

    @Schema(description = "产品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "笔记本")
    @ExcelProperty("产品名称")
    private String name;
    ...
    private Long unitId;
    @Schema(description = "单位", requiredMode = Schema.RequiredMode.REQUIRED, example = "台")
    @ExcelProperty("单位")
    ...
    @Schema(description = "产品备注", example = "这是备注")
    @ExcelProperty("产品备注")
