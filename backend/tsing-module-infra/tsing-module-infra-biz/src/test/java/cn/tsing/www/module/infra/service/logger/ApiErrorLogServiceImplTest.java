...
import cn.tsing.www.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.tsing.www.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.tsing.www.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.tsing.www.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.tsing.www.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.tsing.www.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("tsing-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("tsing-test");
