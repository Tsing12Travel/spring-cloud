package cn.tsing.www.module.infra.service.codegen.inner;
...
import cn.tsing.www.framework.apilog.core.enums.OperateTypeEnum;
...
import cn.tsing.www.framework.excel.core.annotations.DictFormat;
import cn.tsing.www.framework.excel.core.convert.DictConvert;
import cn.tsing.www.framework.excel.core.util.ExcelUtils;
import cn.tsing.www.framework.mybatis.core.dataobject.BaseDO;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "tsing-module-${table.moduleName}/" + // 顶级模块
                "tsing-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "tsing-module-${table.moduleName}/" + // 顶级模块
                "tsing-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "tsing-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "tsing-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
