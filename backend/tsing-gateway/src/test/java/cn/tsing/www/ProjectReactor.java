...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.tsing.cloud";
    private static final String ARTIFACT_ID = "tsing";
    private static final String PACKAGE_NAME = "cn.tsing.www";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.tsing.cloud";
        String artifactIdNew = "tsing";
        String packageNameNew = "cn.tsing.www";
        String titleNew = "管理系统";
//        String projectBaseDirNew = projectBaseDir + "-new"; // 一键改名后，“新”项目所在的目录
        String projectBaseDirNew = "/home/tsing/Code/cloud/backend"; // 一键改名后，“新”项目所在的目录
