package cn.tsing.www.framework.ai.core.factory;
...
import cn.tsing.www.framework.ai.config.TsingAiAutoConfiguration;
import cn.tsing.www.framework.ai.config.TsingAiProperties;
...
import cn.tsing.www.framework.common.util.spring.SpringUtils;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            TsingAiProperties.MidjourneyProperties properties = SpringUtil.getBean(TsingAiProperties.class).getMidjourney();
    ...
    /**
     * 可参考 {@link TsingAiAutoConfiguration#deepSeekChatModel(TsingAiProperties)}
     */
    ...
    /**
     * 可参考 {@link TsingAiAutoConfiguration#xingHuoChatClient(TsingAiProperties)}
     */
