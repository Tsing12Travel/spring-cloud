 ...
 *      1）Spring Async：
 *          {@link cn.tsing.www.framework.quartz.config.TsingAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 TsingSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.tsing.www.framework.tenant;
