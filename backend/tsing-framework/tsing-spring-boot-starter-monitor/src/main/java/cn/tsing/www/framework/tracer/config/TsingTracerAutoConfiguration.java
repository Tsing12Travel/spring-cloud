package cn.tsing.www.framework.tracer.config;

import cn.tsing.www.framework.common.enums.WebFilterOrderEnum;
import cn.tsing.www.framework.tracer.core.aop.BizTraceAspect;
import cn.tsing.www.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "tsing.tracer", value = "enable", matchIfMissing = true)
public class TsingTracerAutoConfiguration {
