package cn.tsing.www.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${tsing.websocket.sender-rocketmq.topic}",
        consumerGroup = "${tsing.websocket.sender-rocketmq.consumer-group}",
