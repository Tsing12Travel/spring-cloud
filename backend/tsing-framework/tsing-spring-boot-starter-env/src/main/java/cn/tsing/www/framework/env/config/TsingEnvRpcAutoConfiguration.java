...
import cn.tsing.www.framework.env.core.fegin.EnvLoadBalancerClientFactory;
import cn.tsing.www.framework.env.core.fegin.EnvRequestInterceptor;
...
public class TsingEnvRpcAutoConfiguration {
