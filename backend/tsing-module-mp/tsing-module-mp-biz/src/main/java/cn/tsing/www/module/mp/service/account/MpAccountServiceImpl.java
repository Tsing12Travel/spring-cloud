package cn.tsing.www.module.mp.service.account;
...
import cn.tsing.www.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.tsing.www.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.tsing.www.module.mp.convert.account.MpAccountConvert;
import cn.tsing.www.module.mp.dal.dataobject.account.MpAccountDO;
import cn.tsing.www.module.mp.dal.mysql.account.MpAccountMapper;
import cn.tsing.www.module.mp.enums.ErrorCodeConstants;
...
import static cn.tsing.www.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 tsing-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
