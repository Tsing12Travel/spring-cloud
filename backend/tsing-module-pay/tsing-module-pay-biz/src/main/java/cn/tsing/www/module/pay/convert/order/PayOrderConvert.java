package cn.tsing.www.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.tsing.www.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
