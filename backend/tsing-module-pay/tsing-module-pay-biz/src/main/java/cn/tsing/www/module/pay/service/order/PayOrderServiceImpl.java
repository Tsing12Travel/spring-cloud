...
import cn.tsing.www.framework.common.util.date.LocalDateTimeUtils;
...
import cn.tsing.www.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
import cn.tsing.www.framework.pay.core.enums.order.PayOrderStatusRespEnum;
import cn.tsing.www.framework.tenant.core.util.TenantUtils;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/tsing-cloud/issues/I8SM9H 场景
