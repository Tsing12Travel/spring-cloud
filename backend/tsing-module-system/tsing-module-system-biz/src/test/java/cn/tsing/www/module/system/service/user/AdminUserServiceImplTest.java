package cn.tsing.www.module.system.service.user;
...
import cn.tsing.www.framework.common.util.collection.ArrayUtils;
import cn.tsing.www.framework.common.util.collection.CollectionUtils;
import cn.tsing.www.framework.test.core.ut.BaseDbUnitTest;
import cn.tsing.www.module.infra.api.config.ConfigApi;
import cn.tsing.www.module.infra.api.file.FileApi;
import cn.tsing.www.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.tsing.www.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.tsing.www.module.system.controller.admin.user.vo.user.*;
import cn.tsing.www.module.system.dal.dataobject.dept.DeptDO;
import cn.tsing.www.module.system.dal.dataobject.dept.PostDO;
import cn.tsing.www.module.system.dal.dataobject.dept.UserPostDO;
import cn.tsing.www.module.system.dal.dataobject.tenant.TenantDO;
import cn.tsing.www.module.system.dal.dataobject.user.AdminUserDO;
import cn.tsing.www.module.system.dal.mysql.dept.UserPostMapper;
import cn.tsing.www.module.system.dal.mysql.user.AdminUserMapper;
import cn.tsing.www.module.system.enums.common.SexEnum;
import cn.tsing.www.module.system.service.dept.DeptService;
import cn.tsing.www.module.system.service.dept.PostService;
import cn.tsing.www.module.system.service.permission.PermissionService;
...
import static cn.tsing.www.framework.common.util.collection.SetUtils.asSet;
import static cn.tsing.www.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.tsing.www.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.tsing.www.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.tsing.www.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.tsing.www.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.tsing.www.framework.test.core.util.RandomUtils.*;
import static cn.tsing.www.module.system.enums.ErrorCodeConstants.*;
import static cn.tsing.www.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("tsingyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("tsingyuanma");
        ...
        assertEquals("tsingyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("tsingyuanma"))).thenReturn("java");
