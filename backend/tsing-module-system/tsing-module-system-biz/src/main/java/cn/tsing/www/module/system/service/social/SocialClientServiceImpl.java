...
import cn.tsing.www.framework.common.util.cache.CacheUtils;
import cn.tsing.www.framework.common.util.http.HttpUtils;
import cn.tsing.www.framework.common.util.object.BeanUtils;
import cn.tsing.www.module.system.api.social.dto.SocialWxQrcodeReqDTO;
...
import cn.tsing.www.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.tsing.www.module.system.dal.dataobject.social.SocialClientDO;
import cn.tsing.www.module.system.dal.mysql.social.SocialClientMapper;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${tsing.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${tsing.wxa-subscribe-message.miniprogram-state:formal}")
